...
import './style/ClickingGame.css';
import Target from '../Target/Target';
import Countdown from '../Countdown/Countdown';
import { IClickingGameState } from './interfaces/IClickingGameState';
import * as ResultsHelper from '../../helpers/ResultsHelper';
import { Redirect } from 'react-router-dom';
import { randomPosition } from '../../helpers/GameHelper';

class ClickingGame extends React.Component {
    state: IClickingGameState = {
        targets: {},
        settings: {},
        results: {
            score: 0,
